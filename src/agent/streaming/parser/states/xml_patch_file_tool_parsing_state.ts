    ...
    if (!this.foundContentStart) {
      ...
      if (!this.capturedPath) {
        ...
        if (pathMatch) {
          ...
          if (this.deferStart && !this.segmentStarted) {
            ...
            this.context.emit_segment_start((this.constructor as typeof XmlPatchFileToolParsingState).SEGMENT_TYPE, meta);
      ...
      if (contentMatch) {
        ...
        if (!this.segmentStarted) {
          this.context.emit_segment_start((this.constructor as typeof XmlPatchFileToolParsingState).SEGMENT_TYPE, this._get_start_metadata());
          this.segmentStarted = true;
        }
