...
import { MistralJsonSchemaFormatter } from '../../../../../src/tools/usage/formatters/mistral_json_schema_formatter.js';
import { ToolDefinition } from '../../../../../src/tools/registry/tool_definition.js';
import { ParameterDefinition, ParameterSchema, ParameterType } from '../../../../../src/utils/parameter_schema.js';
...
describe('MistralJsonSchemaFormatter', () => {
  it('provides Mistral JSON function format', () => {
