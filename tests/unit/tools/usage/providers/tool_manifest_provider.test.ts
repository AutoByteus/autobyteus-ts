...
import { BaseXmlSchemaFormatter, BaseSchemaFormatter } from '../../../../../src/tools/usage/formatters/base_formatter.js';

const mockRegistry = { getFormatterPairForTool: vi.fn() };

vi.mock('../../../../../src/tools/usage/registries/tool_formatting_registry.js', () => {
