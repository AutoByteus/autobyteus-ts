...
import { GenerateImageTool, EditImageTool } from '../../../../src/tools/multimedia/image_tools.js';
import { ImageClientFactory } from '../../../../src/multimedia/image/image_client_factory.js';
import { downloadFileFromUrl } from '../../../../src/utils/download_utils.js';

vi.mock('../../../../src/utils/download_utils.js', () => ({
