...
vi.mock('../../../../src/tools/usage/formatters/default_json_schema_formatter.js', () => {
  return {
...
vi.mock('../../../../src/tools/usage/formatters/default_xml_schema_formatter.js', () => {
  return {
...
vi.mock('../../../../src/tools/usage/formatters/default_xml_example_formatter.js', () => {
  return {
...
vi.mock('../../../../src/tools/usage/formatters/default_json_example_formatter.js', () => {
  return {
