...
let PtySessionClass: typeof import('../../../../src/tools/terminal/pty_session.js').PtySession | null = null;
let nodePtyAvailable = true;

try {
  await import('node-pty');
  ({ PtySession: PtySessionClass } = await import('../../../../src/tools/terminal/pty_session.js'));
} catch {
